...
CREATE TABLE `agendamento` (
  ...
  `status` enum(
    ...
    'cancelado',
    'no_show'
  ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'agendado',
...
VALUES (
    ...
    2,
    '2026-04-11 00:57:54',
    'Paciente nao compareceu e nao avisou.'
  );
...
VALUES (1, 'Anestesicos', NULL),
  (2, 'Descartaveis', NULL),
  (3, 'Instrumentais', NULL),
  (4, 'Medicamentos', NULL);
...
;
INSERT INTO `centro_cirurgico`
VALUES (
    1,
    1,
    'Bloco A - Cirurgia Geral',
    'Bloco principal de cirurgias gerais',
    1
  ),
  (
    2,
    1,
    'Bloco B - Cardiologia',
    'Especializado em cirurgias cardiacas',
    1
  ),
  (
    3,
...
VALUES (1, 1, 20, '2026-04-11 00:57:54'),
  (1, 2, 15, '2026-04-11 00:57:54'),
  (1, 3, 50, '2026-04-11 00:57:54'),
  (1, 4, 30, '2026-04-11 00:57:54'),
  (1, 5, 100, '2026-04-11 00:57:54'),
  (1, 6, 5, '2026-04-11 00:57:54'),
  (1, 7, 25, '2026-04-11 00:57:54'),
  (2, 1, 10, '2026-04-11 00:57:54'),
  (2, 3, 40, '2026-04-11 00:57:54'),
  (2, 5, 80, '2026-04-11 00:57:54'),
  (2, 7, 20, '2026-04-11 00:57:54'),
  (3, 1, 30, '2026-04-11 00:57:54'),
  (3, 2, 20, '2026-04-11 00:57:54'),
  (3, 3, 60, '2026-04-11 00:57:54'),
  (3, 6, 8, '2026-04-11 00:57:54'),
  (3, 7, 40, '2026-04-11 00:57:54'),
  (4, 3, 30, '2026-04-11 00:57:54'),
  (4, 5, 50, '2026-04-11 00:57:54'),
  (4, 7, 15, '2026-04-11 00:57:54');
...
VALUES (
  ...
  (
    ...
    'Clinica Norte',
    '98765432000199',
    'Rua 90, 500 - Setor Norte, Goiania',
    1,
    '2026-04-11 00:57:54'
  );
...
;
INSERT INTO `grupo`
VALUES (1, 1, 'Medicos', NULL),
  (2, 1, 'Enfermeiros', NULL),
  (3, 1, 'Administradores', NULL),
  (4, 2, 'Medicos Norte', NULL);
...
VALUES (1, 1, 1, '07:00:00', '18:00:00'),
  (2, 1, 2, '07:00:00', '18:00:00'),
  (3, 1, 3, '07:00:00', '18:00:00'),
  (4, 2, 1, '07:00:00', '17:00:00'),
  (5, 3, 1, '06:00:00', '20:00:00'),
  (6, 4, 1, '08:00:00', '16:00:00');
...
VALUES (1, 1, 'Propofol 200mg', 'ampola', 1),
  (2, 1, 'Lidocaina 2%', 'frasco', 1),
  (3, 2, 'Luva cirurgica G', 'par', 1),
  (4, 2, 'Curativo esteril 10x10', 'unidade', 1),
  (5, 2, 'Seringa 20ml', 'unidade', 1),
  (6, 3, 'Bisturi cabo nr 4', 'unidade', 1),
  (7, 4, 'Soro fisiologico 500ml', 'frasco', 1);
...
VALUES (1, 'agendamento.criar', 'Criar agendamentos'),
  (2, 'agendamento.editar', 'Editar agendamentos'),
  (
    3,
  ...
  (6, 'relatorio.visualizar', 'Ver relatorios'),
  (7, 'usuario.gerenciar', 'Gerenciar usuarios');
...
;
INSERT INTO `sala`
VALUES (1, 1, 'Sala 01', 5, 1),
  (2, 1, 'Sala 02', 5, 1),
  (3, 2, 'Sala Cardio', 8, 1),
  (4, 3, 'Sala Norte 01', 4, 1);
...
VALUES (1, 'Cirurgia Geral', 120, NULL, 1),
  (2, 'Cirurgia Cardiaca', 240, NULL, 1),
  (3, 'Colonoscopia', 60, NULL, 1),
  (4, 'Ortopedia', 150, NULL, 1),
  (5, 'Oftalmologia', 45, NULL, 1);
...
VALUES (
    ...
    1,
    'Dr. Ricardo Alves',
    'ricardo@hospital.com',
    '$2b$12$F8JqZj26cFQRTmHpE/ecROYRFJRFRzjAWG3gn5r1Rpq2VMt6L/Al.',
    'CRM-GO-12345',
    'medico',
    NULL,
    1,
